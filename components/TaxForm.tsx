...
const TaxForm: React.FC<TaxFormProps> = ({ onCalculate }) => {
  ...
  return (
    <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 shadow-xl shadow-slate-200/50 border border-slate-100 relative overflow-hidden group">
      ...
      <div className="mb-12">
        <h3 className="text-2xl font-black text-slate-800 mb-2">数据录入配置</h3>
        <p className="text-slate-400 text-sm font-medium">请依据您的真实收入情况或财务计划如实填写</p>
      </div>
            ...
            <div key={field.id} className="relative group/field">
              ...
              <div className="relative">
                ...
                <div className="absolute right-6 top-1/2 -translate-y-1/2 flex flex-col items-end">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">CNY</span>
        ...
        <div className="pt-10 flex flex-col items-center">
          ...
          <div className="mt-10 flex items-center justify-center space-x-8 opacity-30 grayscale group-hover:grayscale-0 transition-all duration-700">
            <div className="h-6 flex items-center border-r border-slate-200 pr-8">
              <span className="text-[10px] font-black text-slate-400 tracking-[0.3em] uppercase">Trusted Algorithms</span>
            </div>
            <div className="flex space-x-6">
              <img src="https://upload.wikimedia.org/wikipedia/commons/2/2e/Visa_2021.svg" className="h-4" alt="visa" />
              <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" className="h-4" alt="paypal" />
              <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Mastercard-logo.svg" className="h-6" alt="mastercard" />
            </div>
          </div>
        </div>
      </form>
