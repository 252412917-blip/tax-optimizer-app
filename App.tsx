        ...
        <header className="flex flex-col items-center mb-16 text-center">
          <div className="mb-8 p-1.5 bg-slate-200/50 backdrop-blur rounded-2xl inline-flex shadow-inner">
            <div className="px-4 py-2 bg-white rounded-xl shadow-sm flex items-center space-x-2">
              ...
              <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">🇨🇳 2024 中国个税计税标准</span>
            </div>
          </div>
        ...
        <footer className="mt-24 border-t border-slate-200 pt-16 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="md:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <span className="font-black text-slate-900 tracking-tighter uppercase">个税筹划引擎</span>
              </div>
              ...
              <div className="flex items-center space-x-2 text-slate-400">
                ...
                <span className="text-[11px] font-medium tracking-wide">所有计算均在本地完成，保护财务隐私</span>
              </div>
            </div>
            ...
            <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="bg-slate-100/50 p-6 rounded-3xl border border-slate-200/50">
                ...
                <p className="text-xs text-slate-500 leading-relaxed italic">
                  本工具计算依据《中华人民共和国个人所得税法》及相关政策公告。筹划结果仅供参考，实际纳税额以税务机关核定为准。
                </p>
              </div>
              <div className="bg-slate-100/50 p-6 rounded-3xl border border-slate-200/50">
                <h4 className="font-bold text-slate-800 mb-3 text-sm">适用范围</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  目前覆盖：综合所得（工资薪金）、全年一次性奖金。不含劳务报酬、特许权使用费等。
                </p>
              </div>
            </div>
          </div>
          <div className="mt-16 pt-8 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex space-x-6">
              <span className="text-[10px] font-bold text-slate-300 uppercase cursor-help hover:text-indigo-400 transition-colors">使用文档</span>
              <span className="text-[10px] font-bold text-slate-300 uppercase cursor-help hover:text-indigo-400 transition-colors">版本记录</span>
            </div>
          </div>
        </footer>
      </div>
